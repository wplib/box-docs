...
# ChangeLog for WPLib Box

## 0.17.0
- Another numerically small change but another **huge** update functionally and stability-wise. 
- Prebuilt PHP component containers for `5.2.4`, `5.6.36`, `7.0.30`, `7.1.18` and `7.2.6`. 
...
- Component `Makefile`s will now log build output.
...
## 0.16.2
 -Catch up on some of the things we missed with `0.16.1`:
...
## 0.10.4 and before
- We did not keep a change log before `0.10.5`.